...
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.00001" name="voltage" id="voltage" class="form-control" value="<?php echo $voltage; ?>" required placeholder="e.g. 230">
                        </div>
                        <div class="form-group">
                            <label for="current">Current (A)</label>
                            <input type="number" step="0.00001" name="current" id="current" class="form-control" value="<?php echo $current; ?>" required placeholder="e.g. 0.5">
                        </div>
                        <div class="form-group">
                            <label for="rate">Current Rate (sen/kWh)</label>
                            <input type="number" step="0.00001" name="rate" id="rate" class="form-control" value="<?php echo $rate; ?>" required placeholder="e.g. 21.80">
                        </div>
    ...
    <div class="row justify-content-center result-container">
        <div class="col-md-10">
            ...
            <!-- SUMMARY BOX AS PER IMAGE -->
            <div class="summary-box">
                <h5 class="font-weight-bold text-uppercase">Power : <?php echo number_format(($voltage * $current) / 1000, 5); ?>kw</h5>
                <h5 class="font-weight-bold text-uppercase">Rate : <?php echo number_format($rate / 100, 3); ?>RM</h5>
            </div>
                ...
                <table class="table table-bordered table-striped bg-white">
                    ...
                    <tbody>
                        <?php foreach ($results as $hour => $data): ?>
                            <tr>
                                <td class="font-weight-bold"><?php echo $hour; ?></td>
                                <td><?php echo $hour; ?></td>
